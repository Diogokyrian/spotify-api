...
class Singer(BaseModel):
    ...
    description = models.TextField(blank=True, null=True, help_text="Enter a brief description of the singer")
...
class Album(BaseModel):
    ...
    singer = models.ForeignKey(Singer, on_delete=models.CASCADE, related_name='albums', help_text="Select the singer for this album")
